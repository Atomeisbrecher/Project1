...
from backend.api_auth.domain.exceptions import AuthRequired
from backend.api_auth.domain.entities import AnonymousUser
from backend.api_core.exceptions import PermissionDenied
